...
public class Rishi_Seller extends Seller{
	...
	public void addBook()
    {
        ...
        Book b3=new Book(Globals.Category.Book,getID()+"-"+"Number_Theory",getID()+"-"+"3", (float) 1300.0, 120);
        ...
        Book b6=new Book(Globals.Category.Book,getID()+"-"+"Graph_Theory",getID()+"-"+"6", (float) 260.0,65);
        productList.add(b1);
        productList.add(b2);
        productList.add(b3);
        productList.add(b4);
